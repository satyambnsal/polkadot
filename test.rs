...
//! DATE: 2021-10-23, STEPS: `50`, REPEAT: 20, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> runtime_parachains::paras_inherent::WeightInfo for WeightInfo<T> {
	...
	fn enter_disputes_only(d: u32, ) -> Weight {
		(8_445_165_000 as Weight)
			// Standard Error: 507_000
			.saturating_add((63_378_000 as Weight).saturating_mul(d as Weight))
